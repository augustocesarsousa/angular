...
export class DataBindingComponent {
  public exemploHTMLInterpolation: string = `
  <h1>{{ texto }}</h1>
  `;
  ...
  public exemploHTMLEventBinding = `
  <button (click)="evento()">Botão</button>
  `;
  public exemploClasseEventBinding = `
  public evento() {alert('Clicou no Botão!')}
  `;
  public evento() {
  ...
  `;
  public exemploClasseTwoWayBinding = `
